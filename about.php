        ...
        <section class="section">
            <div class="container">
                <div class="grid grid-2" style="align-items: center;">
                    ...
                    <div>
                        <img src="/placeholder.svg?height=400&width=500" alt="История FitLab" style="width: 100%; border-radius: 10px;">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section" style="background-color: #f8f9fa;">
            <div class="container">
                ...
                <div class="grid grid-2">
                    ...
                    <div>
                        <img src="/placeholder.svg?height=400&width=500" alt="Тренажерный зал FitLab" style="width: 100%; border-radius: 10px; margin-bottom: 1rem;">
                        <img src="/placeholder.svg?height=300&width=500" alt="Зона отдыха FitLab" style="width: 100%; border-radius: 10px;">
                    </div>
                </div>
            </div>
        </section>
